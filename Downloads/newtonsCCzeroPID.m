...
%{
    Debugging Mode. the extra arguement is for specifying how you want this
    function to be used, how it should output. 
    0. No debugging arguement, outputs only the final values for best Zero
    and best Phase Margin
    1. Debugging Arguement, show incremental zeroes and their phase
    margins
    2. Show gRain value
    3. Plot incremental zeroes and their phases
%}

function [Zret PMret] = newtonsCCzeroPID(Z_orig,GH,varargin)
...
while(gRain<15 && spiral<1000)
    ...
    Zret = Z0.orig;
    PMret = PM.orig;
    disp(['Z0: ',num2str(Zret,'%.4f'),' PM: ',num2str(PMret,'%.4f')]);
